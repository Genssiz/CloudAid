...
public class DataSimulator {
	...
	public static final int SEARCHTEST = 4;
	public static final int EXAMPLETEST = 5;
	...
	public CSAData init(int scenario){
		...
		switch (scenario) {
	        ...
	        case 4:
	        	//for the search engine tests
	        	return this.searchTesting();
	        case 5:
	        	//for the search engine tests
	        	return this.exampleTesting();
	        default: 
	        	System.out.println("SYSTEM: Invalid scenario!!!");
	            return null;
		}
	}
	private CSAData exampleTesting(){
		...
		auxComp = new ServiceTemplate(COMPONENT_PREFIX+componentPreffix++, "web server", "a web server");
		auxComp.setWeight(2);
		...
		auxComp.addReq(auxReq);
		auxReq = new Requirement("min data transfer in > 25TB", null, Enumerator.QUANT_FEATURE.DATAINEXTERNAL);
		auxReq.setMin(25600);
		auxReq.setExclusivityMax(false);
		auxComp.addReq(auxReq);
		
		auxCrit = new Criterion(Enumerator.QUANT_FEATURE.DATAINEXTERNAL.getValue());
		auxCrit.setWeight(3);
		auxCrit.setPreferenceDirection("max");
		auxCrit.setType(0); //numerical criterion
		auxComp.addCrit(auxCrit);
		auxCrit = new Criterion(Enumerator.QUAL_FEATURE.UNIX.getValue());
		auxCrit.setWeight(2);
		auxCrit.setPreferenceDirection("max");
		...
		auxCrit.setWeight(1);
		auxCrit.setPreferenceDirection("max");
		auxCrit.setType(2); //non_numerical criterion
		auxComp.addCrit(auxCrit);
		
		comps.add(auxComp);
		
		//Template 2 data processing
		auxComp = new ServiceTemplate(COMPONENT_PREFIX+componentPreffix++, "data processing", "a data processing unit");
		auxComp.setWeight(2);
		...
		auxReq.setQualValue("java");
		auxComp.addReq(auxReq);
		auxReq = new Requirement("min data transfer in > 100TB", null, Enumerator.QUANT_FEATURE.DATAINEXTERNAL);
		auxReq.setMin(102400);
		auxReq.setExclusivityMax(false);
		auxComp.addReq(auxReq);
		...
		auxComp.addCrit(auxCrit);
		auxCrit = new Criterion(Enumerator.QUAL_FEATURE.UNIX.getValue());
		auxCrit.setWeight(1.5);
		auxCrit.setPreferenceDirection("max");
		auxCrit.setType(1); //binary criterion
		auxComp.addCrit(auxCrit);
		auxCrit = new Criterion(Enumerator.QUAL_FEATURE.BIT64.getValue());
		auxCrit.setWeight(1);
		auxCrit.setPreferenceDirection("max");
		auxCrit.setType(1); //binary criterion
		auxComp.addCrit(auxCrit);
		...
		//Template 1 database
		auxComp = new ServiceTemplate(COMPONENT_PREFIX+componentPreffix++, "database", "database");
		auxComp.setWeight(2);
		...
		auxReq.setExclusivityMax(false);
		auxComp.addReq(auxReq);
		auxReq = new Requirement("min cache size > 2GB", null, Enumerator.QUANT_FEATURE.CACHESIZE);
		auxReq.setMin(2);
		auxReq.setExclusivityMax(false);
		auxComp.addReq(auxReq);
		
		auxCrit = new Criterion(Enumerator.QUANT_FEATURE.CACHESIZE.getValue());
		auxCrit.setWeight(3);
		auxCrit.setPreferenceDirection("max");
		auxCrit.setType(0); //numerical criterion
		auxComp.addCrit(auxCrit);
		...
		auxReq.setDescription("price must be bellow 7");
		auxReq.setMax(7);
		auxReq.setExclusivityMax(true);
		reqs.add(auxReq);
		
		//general criterion
		auxCrit = new Criterion("price");
		auxCrit.setWeight(2);
		auxCrit.setPreferenceDirection("min");
		auxCrit.setType(0);
		criteria.add(auxCrit);
		
		return new CSAData(comps, reqs, criteria);
	}
	
	private CSAData searchTesting(){
		ArrayList<ServiceTemplate> comps = new ArrayList<ServiceTemplate>() ;
		ArrayList<Requirement> reqs = new ArrayList<Requirement>() ;
		ArrayList<Criterion> criteria = new ArrayList<Criterion>() ;
...
//		auxReq.setCriterion(true);
		...
		auxReq.setExclusivityMax(false);
		auxComp.addReq(auxReq);
		auxReq = new Requirement("must be linux", Enumerator.QUAL_FEATURE.UNIX, null);
		auxReq.setPositive(true);
		auxReq.setQualValue("Linux");
		auxComp.addReq(auxReq);
		auxReq = new Requirement("must have SSD storage", Enumerator.QUAL_FEATURE.STORAGETYPE, null);
		auxReq.setPositive(true);
		auxReq.setQualValue("SSD");
		auxComp.addReq(auxReq);
		auxReq = new Requirement("min memory capacity > 1GB", null, Enumerator.QUANT_FEATURE.MEMORYSIZE);
		auxReq.setMin(1);
		auxReq.setExclusivityMax(false);
//		auxReq.setCriterion(true);
		auxComp.addReq(auxReq);
